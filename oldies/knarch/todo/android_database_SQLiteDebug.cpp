...
extern "C" JNIEXPORT void JNICALL Java_android_database_SQLiteDebug_nativeGetPagerStats(JNIEnv *env, jobject clazz, jobject statsObj)
{
    nativeGetPagerStats(env, clazz, statsObj);
}
/*
 * JNI registration.
 */
